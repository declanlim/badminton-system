...
<div class='container-fluid'>
    ...
    if(isset($_GET['newTournamentSubmit']))
    {
        $tournament = new Tournament();

//        $tournament->NewTournament($_GET['tournamentName']);
        echo $_GET['tournamentName'] . "\n";
        echo $_GET['tournamentDescription'] . "\n";
        echo $_GET['startDate'] . "\n";
        echo $_GET['endDate'] . "\n";
        echo $_GET['minAge'] . "\n";
        echo $_GET['maxAge'] . "\n";
    ...
    <form class='needs-validation' action='newTournament.php' method='get' novalidate>
        ...
        <div class='row'>
            <div class='form-group col-md-3'>
                ...
                <input class='form-control' type='date' id='startDate' name='startDate'
                       min='<?php echo date('Y-m-d') ?>' onchange='setMinEndDate(this.value)' required>
                <div class='invalid-feedback'>
            ...
            <div class='form-group col-md-3'>
                ...
                <input class='form-control' type='date' id='endDate' name='endDate' required disabled onchange='setDayForm()'>
                <div class='invalid-feedback'>
        ...
        <div class='form-row'>
            <div class='col-auto my-1'>
                <input class='form-control btn btn-primary' name='newTournamentSubmit' type='submit' value='Create my tournament'>
            </div>
        </div>
    </form>
</div>
